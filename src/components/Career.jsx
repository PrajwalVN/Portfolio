        ...
        <>
            ...
            <div className="absolute -z-0">
                <svg height="1500" width="300" className='z-[-1]'>
                    <line x1="200" y1="200" x2="200" y2="1100" stroke='white' strokeWidth={2} />
            ...
            <div ref={direction('left')}  className=" text-[#ffffff] my-[24vh] ml-[17vw] text-[1.5rem]">
                <h1>10th</h1>
                <h2>Kendriya Vidyalaya Mhow (M.P)</h2>
                <h3>Score: <span className='text-[#ff243d]'>92.8%</span></h3>
            </div>
            <div  ref={direction('left')} className=" text-[#ffffff] my-[24vh] ml-[17vw] text-[1.5rem]">
                <h1>12th</h1>
                <h2>Kendriya Vidyalaya Mhow (M.P)</h2>
                <h3>Score: <span className='text-[#ff243d]'>94%</span></h3>
            </div>
            <div ref={direction('left')}  className=" text-[#ffffff] my-[24vh] ml-[17vw] text-[1.5rem] ">
                <h1>Collage (2nd)</h1>
                <h2>VIT Chennai (Tamil Nadu)</h2>
                <h3>Score: <span className='text-[#ff243d]'>8.82 GPA</span></h3>
            </div>
            <div ref={direction('left')} className=" text-[#ffffff] my-[24vh] ml-[17vw] text-[1.5rem] ">
